<template>
  <NavBar></NavBar>
  <div class="flex items-center h-[calc(100vh-70px)] p-8 bg-[--vt-c-white-soft]">
    <div class="flex flex-col w-full gap-3">
      ...
      <div class="mt-5 grid justify-items-center">
        ...
        <div class="mt-5 bg-white p-4 rounded-full">
          <button
            class="bg-[#FF0000] focus:bg-red-600 rounded-full p-2 ring-1 ring-[#FF0000] ring-offset-4"
          >
