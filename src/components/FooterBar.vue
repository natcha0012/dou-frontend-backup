<template>
  <footer
    ...
    <RouterLink to="/stock" v-if="user?.role !== UserRole.DELIVER">
      <div v-if="props.focus === 'My Stock'" class="w-fit flex justify-center items-center flex-col gap-1">
    ...
    <RouterLink to="/production" v-if="user?.role !== UserRole.DELIVER">
      <div v-if="props.focus === 'Production'" class="w-fit flex justify-center items-center flex-col gap-1">
    ...
    <RouterLink to="/branchs" v-if="user?.role !== UserRole.DELIVER">
      <div v-if="props.focus === 'Our Branches'" class="w-fit flex justify-center items-center flex-col gap-1">
    ...
    <RouterLink to="/orders">
      <div v-if="props.focus === 'Orders'" class="w-fit flex justify-center items-center flex-col gap-1">
    ...
    <RouterLink to="/profile">
      <div v-if="props.focus === 'Profile'" class="w-fit flex justify-center items-center flex-col gap-1">
